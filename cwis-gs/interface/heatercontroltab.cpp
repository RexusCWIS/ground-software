...
void HeaterControlTab::sidePanelSetup()
{
    ...
    m_laserOnButton  = new QRadioButton(tr("Laser On"), m_uplinkBox);
    m_laserOffButton = new QRadioButton(tr("Laser Off"), m_uplinkBox);

    m_laserOffButton->setChecked(true);
    QObject::connect(m_laserOnButton, SIGNAL(toggled(bool)),
    ...
    m_uplinkBoxLayout->addWidget(m_laserOnButton, 3, 0, 1, 2, Qt::AlignCenter);
    m_uplinkBoxLayout->addWidget(m_laserOffButton, 4, 0, 1, 2, Qt::AlignCenter);
    m_uplinkBoxLayout->addWidget(m_heaterDutyCycleTextLabel, 5, 0);
    m_uplinkBoxLayout->addWidget(m_heaterDutyCycleValueLabel, 5, 1);
